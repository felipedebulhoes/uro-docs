...
- Figuras cadastradas: 291
- Figuras com imagem: 91
- Figuras pendentes de imagem: 200
- Entradas por situação: cobertura parcial (49), sem imagem (13), coberto (5), sem figuras (2)
...
| pieloplastia | Pieloplastia videolaparoscópica/robótica (Anderson-Hynes) para estenose de JUP | Endourologia | 0/5 | 5 | sem imagem |
...
| vasectomia-tecnica-sem-bisturi | Vasectomia (técnica sem bisturi) | Saúde do Homem | 0/5 | 5 | sem imagem |
...
| holep | Enucleação da Próstata a Laser de Hólmio (HoLEP) para HPB | Próstata | 1/5 | 4 | cobertura parcial |
| epididimectomia | Epididimectomia | Saúde do Homem | 1/5 | 4 | cobertura parcial |
| hidrocelectomia-tecnicas-de-jaboulay-e-lord | Hidrocelectomia (técnicas de Jaboulay e Lord) | Saúde do Homem | 1/5 | 4 | cobertura parcial |
...
| leco | Litotripsia Extracorpórea por Ondas de Choque (LECO/SWL) para cálculo urinário | Endourologia | 0/4 | 4 | sem imagem |
| nefrolitotripsia-percutanea | Nefrolitotripsia Percutânea (NLP) para cálculo renal | Endourologia | 0/4 | 4 | sem imagem |
...
| sling-masculino | Sling masculino para incontinência urinária pós-prostatectomia | Funcional | 0/4 | 4 | sem imagem |
| rezum | Termoterapia prostática por vapor d'água (Rezūm) para HPB | Próstata | 0/4 | 4 | sem imagem |
...
| uretrotomia-interna | Uretrotomia Interna (técnica de Sachse) para estenose de uretra | Funcional | 0/4 | 4 | sem imagem |
...
| hpb-tratamento-cirurgico | HPB — Tratamento Cirúrgico (RTU-P / HoLEP / Enucleação) | Próstata | 0/3 | 3 | sem imagem |
| hpb-tratamento-clinico | HPB — Tratamento Clínico (IPSS, Alfa-bloqueadores, 5-ARIs) | Próstata | 0/3 | 3 | sem imagem |
...
| prepucioplastia-plastica-prepucial-poupadora-de-prepucio | Prepucioplastia / plástica prepucial poupadora de prepúcio | Saúde do Homem | 0/3 | 3 | sem imagem |
...
| investigacao-metabolica-litiase | Investigação Metabólica — Litíase Recorrente | Endourologia | 0/2 | 2 | sem imagem |
...
| priapismo-isquemico | Priapismo Isquêmico | Urgência | 0/1 | 1 | sem imagem |
| terapia-expulsiva-calculo-ureteral | Terapia Expulsiva — Cálculo Ureteral | Endourologia | 0/1 | 1 | sem imagem |
...
| investigacao-cancer-prostata | Investigação do Câncer de Próstata | Diagnóstico | 0/0 | 0 | sem figuras |
| seguimento-pos-prostatectomia | Seguimento Pós-Prostatectomia | Oncologia | 0/0 | 0 | sem figuras |
