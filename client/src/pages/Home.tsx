              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Passo a passo técnico de 56 procedimentos — endourologia, oncologia, próstata, andrologia, imagem (USG/Doppler), estética genital e saúde do homem, baseado em evidências.
                  </p>
                </div>
              </div>
            </Card>
