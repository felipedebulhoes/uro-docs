...
/**
 * Isótipo oficial do Dr. Felipe Bulhões (monograma "B").
 * Extraído de felipebulhoes.com (isotipo-fb.svg).
 * As duas formas usam tons claros, próprios para fundo escuro (azul petróleo).
 */
export function BrandLogo({ className, title = "Dr. Felipe Bulhões" }: BrandLogoProps) {
  return (
    <svg
      viewBox="0 0 1295.52 1888.96"
      className={className}
      role="img"
      aria-label={title}
